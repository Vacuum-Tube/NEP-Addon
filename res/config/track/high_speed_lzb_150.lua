function data()
	...
	t.name = _("High-speed tracks lzb 150")
	t.desc = _("Specialized tracks for higher speeds. lzb 150")

	t.categories = 					{ _("Rusty_rail"),"1435mm", "150 km_h", } --{ "1435mm", _("Rusty_rail"), "140 km_h", }
