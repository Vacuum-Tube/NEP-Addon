function data()
	...
	t.name = _("High-speed tracks lzb 70")
	t.desc = _("Specialized tracks for higher speeds. lzb 70")

	t.categories = 					{ _("Rusty_rail"),"1435mm", "70 km_h", } --{ "1435mm", _("Rusty_rail") }
