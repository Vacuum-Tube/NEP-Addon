function data()
	...
	t.name = _("Low-speed tracks 160")
	t.desc = _("Specialized tracks for higher speeds. low 160")

	t.categories = 					{ _("new_rails"),"1435mm", "160 km_h", } --{ _("new_rails"),"120 km_h", }
